...
🎯**Business Objectives:**
- Analyze employee distribution by department, gender, age, and region
- Track performance ratings and leave patterns
- Understand salary allocation across job roles
- Monitor employment status (Full-time, Part-time, Contract)
- Identify work location trends (Remote, Branch, Head Office)
...
- 📊Performance Analysis – Average rating visualization
- 🧑‍💼Employee Demographics – Age, gender, region insights
- 💰Salary Analysis – Manager, Developer, Analyst, Designer, HR Specialist
- 🏠Work Location Trends – Remote vs Office
...
- Managers and HR roles contribute major salary share
